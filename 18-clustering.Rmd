...
* __Exercise 4__: Check out differentially expressed genes and marker genes for the obtained clusterings. Please use $k=3$. MH: there is no question here... we should ask them to do something more specific, such as running a GO analysis or identifying possible surface markers
...
patient.sceset <- sc3_prepare(patient.sceset, ks = 2:5)
```
...
```{r clust-tsne-kmeans2, fig.cap = "tSNE map of the patient data with 2 colored clusters, identified by the k-means clustering algorithm"}
clusts <- kmeans(
    tsne_out$Y,
    centers = 2,
    iter.max = 1e+09,
