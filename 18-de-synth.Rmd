...
using 100 genes from 40 cells. To simulate the second experimental
...
```{r synthetic-roc-curve-ks, fig.cap = "Different distributions of read counts for a single genes across 40 cells based on the Poisson-Beta model corresponding to different paramete sets"}
...
```{r synthetic-roc-curve-deseq, fig.cap = "Different distributions of read counts for a single genes across 40 cells based on the Poisson-Beta model corresponding to different paramete sets"}
