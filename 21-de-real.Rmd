...
Because the number of genes now is `r dim(biase)[1]`, which is about 100 times more than the number of genes we used for the synthetic dataset, this calculation will take some time. You do __not__ need to run it during the course, instead just check the results below.
...
Because the number of genes now is `r dim(biase)[1]`, which is about 100 times more than the number of genes we used for the synthetic dataset, this calculation will take quite a lot of time. You do __not__ need to run it during the course, instead just check the results below.
