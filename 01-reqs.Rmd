...
```
[scRNA.seq.course](https://github.com/hemberg-lab/scRNA.seq.course) - the main course package (it also contains all materials and slides in __inst/materials__ folder):
```{r, eval=FALSE, message=FALSE, warning=FALSE}
devtools::install_github("hemberg-lab/scRNA.seq.course")
```
