...
```{r clust-pca, echo=FALSE, fig.cap="Schematic representation of PCA dimensionality reduction (taken from [here](http://www.nlpca.org/pca_principal_component_analysis.html))", out.width='100%'}
...
```{r expr-overview-pca-after-qc-exercise1-1, fig.cap = "PCA plot of the blischak data (14214 genes)"}
scater::plotPCA(umi.qc[endog_genes, ],
                ntop = 14214,
                colour_by = "batch",
                size_by = "total_features",
...
```{r expr-overview-pca-after-qc-exercise1-2, fig.cap = "PCA plot of the blischak data (50 genes)"}
scater::plotPCA(umi.qc[endog_genes, ],
                ntop = 50,
                colour_by = "batch",
                size_by = "total_features",
...
```{r expr-overview-tsne-after-qc-exercise2-1, fig.cap = "tSNE map of the blischak data (perplexity = 10)"}
scater::plotTSNE(umi.qc[endog_genes, ],
                 ntop = 500,
                 perplexity = 10,
                 colour_by = "batch",
...
```{r expr-overview-tsne-after-qc-exercise2-2, fig.cap = "tSNE map of the blischak data (perplexity = 200)"}
scater::plotTSNE(umi.qc[endog_genes, ],
                 ntop = 500,
                 perplexity = 200,
                 colour_by = "batch",
