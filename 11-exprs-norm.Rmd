...
```{r norm-pca-raw, fig.cap = "Cell-wise RLE of the blischak data"}
boxplot(calc_cell_RLE(counts(umi.qc)), col="grey50", ylab="RLE", main="")
```
...
```
```{r norm-pca-raw, fig.cap = "Cell-wise RLE of the blischak data"}
boxplot(calc_cell_RLE(cpm(umi.qc)), col="grey50", ylab="RLE", main="")
```
...
```
```{r norm-pca-raw, fig.cap = "Cell-wise RLE of the blischak data"}
boxplot(calc_cell_RLE(norm_counts(umi.qc)), col="grey50", ylab="RLE", main="")
```
