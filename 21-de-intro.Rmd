...
```{r nb-plot, fig.cap="Distribution of read counts for a single gene across 1000 cells based on the Negative Binomial model"}
set.seed(1)
...
```{r zero-inflation-plot, fig.cap="Distribution of read counts for a single gene based on a zero-inflated Negative Binomial model"}
d = 0.5;
