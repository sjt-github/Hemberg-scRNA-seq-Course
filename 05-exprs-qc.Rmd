...
molecular identifiers (UMIs) and ERCC _spike-ins_ were used. For our purposes you need to download the files [`annotation.txt`](http://genat.uk/bookdown-demo/blischak/annotation.txt), [`molecules.txt`](http://genat.uk/bookdown-demo/blischak/molecules.txt), and [`reads.txt`](http://genat.uk/bookdown-demo/blischak/reads.txt) into the `blischak` folder in your working directory. These files are the copies of the original files made on the 15/03/16. We will use these copies for reproducibility purposes.
