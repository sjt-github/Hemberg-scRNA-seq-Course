...
<img src="12-confounders-reads_files/figure-html/confound-pca-reads-1.png" alt="PCA plot of the blischak data" width="90%" />
<p class="caption">(\#fig:confound-pca-reads)PCA plot of the blischak data</p>
</div>
