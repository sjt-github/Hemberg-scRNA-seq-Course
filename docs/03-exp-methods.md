...
<p class="caption">(\#fig:unnamed-chunk-2)Image of microwell plates (image taken from Wikipedia)</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-3)Image of a 96-well Fluidigm C1 chip (image taken from Fluidigm)</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-4)Schematic overview of the drop-seq method (Image taken from Macosko et al)</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-5)Enard group study</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-6)Teichmann group study</p>
</div>
