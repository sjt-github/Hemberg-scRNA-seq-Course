...
<div class="figure" style="text-align: center">
<img src="14-exprs-norm-reads_files/figure-html/norm-ours-rle-raw-reads-1.png" alt="Cell-wise RLE of the tung data" width="90%" />
<p class="caption">(\#fig:norm-ours-rle-raw-reads)Cell-wise RLE of the tung data</p>
</div>
