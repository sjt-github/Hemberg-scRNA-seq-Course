...
pseudotime_order_tscan <- cellLabels[as.numeric(dengorderTSCAN)]
...
pseudotime_order_monocle = as.character(Pseudotime[order(Pseudotime$time),1])
...
matched_ordering = match(as.character(pseudotime_order_monocle),pseudotime_order_tscan)
