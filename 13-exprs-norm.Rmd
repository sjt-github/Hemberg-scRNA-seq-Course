...
```{r norm-ours-rle-raw, fig.cap = "Cell-wise RLE of the tung data"}
...
```{r norm-pca-fpkm, fig.cap = "PCA plot of the tung data after FPKM normalisation"}
...
```{r norm-pca-tpm, fig.cap = "PCA plot of the tung data after TPM normalisation"}
scater::plotPCA(umi.qc.ann,
                colour_by = "batch",
                size_by = "total_features",
                shape_by = "individual",
